...
/*
  •---------------------------------------•
  • Iconos específicos para este proyecto •
  •---------------------------------------•
*/
IconeJz.createIcon('jz-folder', 
`<div class="jz flexjz jz-folder--content contentIconejz">
  <div class="jz jz-folder-by">
    <div class="jz jz-folder-cb"></div>
  </div>
</div>`
);